...
func TestHashFunctions(t *testing.T) {
	...
	testHashingFunctions(t, "xxh3 hash assertion", func(clave string) uint64 { return xxh3.Hash(toBytes3(clave)) })
	...
	testHashingFunctions(t, "Jenkins assertion", func(clave string) uint64 { return _JenkinsHashFunction(toBytes3(clave)) })
}
